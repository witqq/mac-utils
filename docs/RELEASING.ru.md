...
- `APP_STORE_CONNECT_PRIVATE_KEY_BASE64` — base64 API-ключа App Store Connect в формате `.p8`;
...
Повторный запуск безопасен: workflow работает с тем же тегом и release, заменяет только два версифицированных и заново проверенных asset и не создаёт второй release. Никогда не переносите и не переписывайте опубликованный тег. Изменение исходников требует новой patch-версии.
